...
mkdir -p /home/$client_user/

cd /home/$sourceu/docker-compose/ && docker-compose down


cp -rvf /home/$sourceu/* /home/$client_user

cd /home/$sourceu/docker-compose/ && docker-compose up -d
